<template>
  <div class="v-wallet-section_options">
    <template>
		<div v-for="(item, index) of list" class="t-options_single" :id="item.id" :key="index">
			<p class="t-options_single__title">{{ item.heading }}</p>
			<div class="t-options_single_inner">
				<div class="t-options_single_inner__img_wrap" :style="item.bg_color"></div>
				<div class="t-options_single_inner__content_wrap">
					<h3 class="t-options_single_inner_title">{{ item.title }}</h3>
					<p class="t-options_single_inner_content">{{ item.content }}</p>
					<template v-if="item.dropdown === true">
					<div class="t-options_single_drop">
