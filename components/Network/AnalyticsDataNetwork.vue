  ...
  <div class="c-analytics">
    <div class="container">
      <div class="c-analytics_data orange_bg">
        <p class="c-analytics_data__value">10.31 Gb/s</p>
        <hr />
        <h3 class="c-analytics_data__title">Network Bandwidth</h3>
      </div>
      <div class="c-analytics_data blue_bg">
        <p class="c-analytics_data__value">2,496,868,113</p>
        <hr />
        <h3 class="c-analytics_data__title">Encryptions / Sec</h3>
      </div>
      <div class="c-analytics_data green_bg">
        <p class="c-analytics_data__value">3,350</p>
        <hr />
        <h3 class="c-analytics_data__title">24Hr Transactions</h3>
      </div>
    </div>
  </div>
</template>
